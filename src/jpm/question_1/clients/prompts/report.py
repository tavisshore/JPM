def get_report_prompt(pdf_text: str) -> str:
    extraction_prompt = (
        ...
        "4. Financial liabilities - non-current (from non-current liabilities "
        "section)\n"
        "5. Financial liabilities - current (from current liabilities section)\n"
        ...
        "9. EBIT (Operating result / Operating profit)\n"
        "10. Interest expense (Interest expense / Finance costs)\n"
        "11. Revenue (Sales revenue / Revenue)\n"
        "12. Operating expenses (sum of Distribution + Administrative + Other "
        "operating expenses)\n\n"
        "From Cash Flow Statement or Notes:\n"
        "13. Depreciation and amortization (total of all D&A line items)\n\n"
        ...
        "- Extract EXACTLY as printed, no calculations\n"
        ...
        '  "financial_liabilities_noncurrent": <number>,\n'
        '  "financial_liabilities_current": <number>,\n'
        '  "equity": <number>,\n'
        '  "total_assets": <number>,\n'
        '  "net_income": <number>,\n'
        '  "ebit": <number>,\n'
        ...
        "}\n\n"
        "Numbers must have NO commas. All values must be plain numbers.\n\n"
        f"{pdf_text}"
    )
