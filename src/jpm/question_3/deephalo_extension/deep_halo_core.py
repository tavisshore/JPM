...
from jpm.question_3.deephalo_extension.layers import BaseEncoder, HaloBlock
from jpm.question_3.deephalo_extension.utils import masked_log_softmax
...
class DeepHalo(tf.keras.Model):
    ...
    def __init__(self, cfg: DeepHaloConfig, name: str = "DeepHalo"):
        ...
        self.blocks = [
            HaloBlock(cfg, name=f"halo_block_l{layer}") for layer in range(cfg.n_layers)
        ]
