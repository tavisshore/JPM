...
from jpm.question_3.deephalo_extension.utils import masked_mean
...
class HaloBlock(tf.keras.layers.Layer):
    ...
    def call(
        ...
        # each item is updated by a nonlinear function of its own embedding plus the context summary.
        upd = 0.0
